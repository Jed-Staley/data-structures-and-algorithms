...
const hasChildrenValues = (arr, character) => {
  for (let i = 0; i < arr.length; i++) {
    if (Object.values(arr[i]).includes(character) && arr[i].children.length > 0) {
      return true;
    }
  }
  return false;
...
const totalCharacters = (arr) => {
  ...
  arr.forEach((obj) => {
    totalNum++;
    totalNum += (obj.spouse === null) ? 0 : 1;
    totalNum += (obj.children !== undefined) ? obj.children.length : 0;
  });
  return totalNum;
};
...
const houseSize = (arr) => {
  ...
  arr.forEach((obj) => {
    let size = 1;
    size += (obj.spouse === null) ? 0 : 1;
    size += (obj.children !== undefined) ? obj.children.length : 0;
    sizes.push({ house: obj.house, members: size });
  });
  return sizes;
};
...
const houseSurvivors = (arr) => {
  ...
  arr.forEach((obj) => {
    let size = 1;
    size += (obj.spouse === null || deceasedSpouses.includes(obj.spouse)) ? 0 : 1;
    size += (obj.children !== undefined) ? obj.children.length : 0;
    survivors.push({ house: obj.house, members: size });
  });
  return survivors;
};
