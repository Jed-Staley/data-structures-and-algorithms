...
const sortByChildren = charArray => charArray.sort((obj1, obj2) => (obj1.children.length === obj2.children.length) ? obj1.house.localeCompare(obj2.house) : obj1.children.length - obj2.children.length);
