...
const mapTwoToThe = arr => arr.map(power => Math.pow(2, power));
...
const extractStats = arr => arr.map(chosenStat => ({name: chosenStat.stat.name, total: chosenStat.effort + chosenStat.baseStat}));
